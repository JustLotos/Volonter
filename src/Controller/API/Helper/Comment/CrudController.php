...
class CrudController extends AbstractController
{
    ...
    /** @Route("/cget/", name="getAllComments", methods={"GET"}) */
    public function getAllComments(CommentRepository $repository) : Response
    {
        /** @var User $user */
        $user = $this->getUser();
        $comments = $repository->getAll(new Id($user->getId()->getValue()));
