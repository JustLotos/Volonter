...
class CrudController extends AbstractController
{
    ...
    /** @Route("/cget/{id}", name="getAllCommentsByTask", methods={"GET"}) */
    public function getAllCommentsByTask(CommentRepository $repository, string $id) : Response
    {
        $comments = $repository->getAllByTask(new Id($id));

        return  $this->response($this->serializer->serialize($comments,  Comment::GROUP_SIMPLE));
    }
//
//    /** @Route("/get/{id}/", name="getComment", methods={"GET"}) */
//    public function getComment(CommentRepository $repository, Comment $comment) : Response
//    {
